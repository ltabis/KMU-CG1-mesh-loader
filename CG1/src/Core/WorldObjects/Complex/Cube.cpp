...
CG::Cube::Cube(const glm::vec3& position, const glm::vec3& rotation, const glm::vec3& scale)
	: AShape()
{
...
const CG::VertexArray& CG::Cube::vao() const
{
	return *_vao;
}

const CG::IndexBuffer& CG::Cube::ibo() const
{
	return *_ibo;
}
