...
CG::Plane::Plane(const glm::vec3& position, const glm::vec3& rotation, const glm::vec3& scale)
	: AShape()
{
...
const CG::VertexArray& CG::Plane::vao() const
{
	return *_vao;
}

const CG::IndexBuffer& CG::Plane::ibo() const
{
	return *_ibo;
}
